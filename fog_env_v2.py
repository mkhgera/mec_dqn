...
class Offload:
    ...
    def __init__(self, num_iot, num_fog, num_time, max_delay, image_name):
        ...
        for i in range(num_fog):
            container_name = f"fog_node_{i}"
            self.docker_client.containers.run(image_name, detach=True, name=container_name)
